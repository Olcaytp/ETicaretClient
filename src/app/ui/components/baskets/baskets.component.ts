...
import { Update_Basket_Item } from 'src/app/contracts/basket/update_baset_item';
import { Create_Order } from 'src/app/contracts/order/create_order';
import { BasketItemRemoveDialogComponent, BasketItemDeleteState } from 'src/app/dialogs/basket-item-remove-dialog/basket-item-remove-dialog.component';
  ...
  removeBasketItem(basketItemId: string) {
    ...
    this.dialogService.openDialog({
      ...
      afterClosed: async () => {
        ...
        var a = $("." + basketItemId)
        $("." + basketItemId).fadeOut(500, () => this.hideSpinner(SpinnerType.BallSpinFadeRotating));
